                    ...
                    <Box w={{ base: '95%', lg: '90%' }} m='30px auto' >
                        ...
                        <Box w='100%' borderRadius='15px' boxShadow='lg' backgroundColor='#E7EDE4'>
                            <Box display='flex' flexDirection={{ base: 'column', sm: 'column', md: 'row' }} >
                                <Box fontWeight='semibold' color='#f7f1e3' textShadow='1px 1px 1.5px #000' fontSize='18px' flexGrow='1' p={{ base: '50px 12px', md: '40px' }} backgroundColor={pokemon.color} borderTopLeftRadius='15px' borderTopRightRadius={{ base: '15px', md: '0' }} borderBottomLeftRadius={{ base: '0', md: '15px' }}>
